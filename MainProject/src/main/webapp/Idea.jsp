			...
			<article class="post">
				...
				<div align="center" allowTransparency="true">
					<iframe width="52%" height="164" scrolling="no" frameborder="no"
						...
						src="https://mp3web.com/music/track/8126/merry-go-round-feat-ziont,-wonstein-prod-slom/embed"></iframe>
					<iframe width="52%" height="164" scrolling="no" frameborder="no"
						allow="autoplay" allowTransparency="true"
						src="https://mp3web.com/music/track/53729/when-i-was-your-man/embed"></iframe>
					<iframe width="52%" height="164" scrolling="no" frameborder="no"
						allow="autoplay" allowTransparency="true"
						src="https://mp3web.com/music/track/11761/on-rainy-days-2021/embed"></iframe>
					<iframe width="52%" height="164" scrolling="no" frameborder="no"
						allow="autoplay" allowTransparency="true"
						src="https://mp3web.com/music/track/7341/shallow/embed"></iframe>
					<iframe width="52%" height="164" scrolling="no" frameborder="no"
						allow="autoplay" allowTransparency="true"
						src="https://mp3web.com/music/track/9182/1245-stripped/embed"></iframe>
				</div>
			</article>
		</div>
		<!-- Footer -->
