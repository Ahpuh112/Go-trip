...
const goResult = () => {
  ...
  const tripInfo_div = document.querySelector('.tripInfo_div');
  const tripInfo = document.createElement('a');
  ...
  tripInfo_div.append(tripInfo)
  tripInfo.href = infoList[grade].href;
  tripInfo.innerHTML = infoList[grade].text;
